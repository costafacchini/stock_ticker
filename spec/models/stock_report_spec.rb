...
RSpec.describe StockReport, type: :model do
  describe "#report" do
    it "returns an array of items" do
      ticker = Struct.new(:maximum_price, :minimum_price, :average_price, :maximum_volume, :minimum_volume, :average_volume)
                     .new(10.0, 5.0, 7.5, 4.0, 2.0, 3.0)
